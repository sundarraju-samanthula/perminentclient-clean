import 'package:client_app/screen/splash_screen.dart';
...
Future<void> main() async {
  ...
  OneSignal.initialize("68e682b4-4372-40c1-9247-f636d3f4358b");
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => UserProvider(DataProvider())),
        ChangeNotifierProvider(
